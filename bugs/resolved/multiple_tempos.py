"""
Bug: the recording on the flute clock is rendering with accelerandi and retardandi in the (flat) segments of the
tempo curve. Floating point error? Regardless, probably some kind of rounding/thresholding would be helpful.
"""
