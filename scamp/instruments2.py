...
class PlaybackImplementer:
    ...
    def _do_start_note(self, pitch, volume, properties, other_parameter_values: dict = None):
        ...
        if other_parameter_values is not None:
            for param, value in other_parameter_values.items():
                self._note_info_by_id[note_id]["parameter_start_values"][param] = \
                    self._note_info_by_id[note_id]["parameter_values"][param] = value
...
class ScampInstrument(PlaybackImplementer):
    ...
    def start_note(self, pitch, volume, properties=None, clock="auto", silent=False, transcribe=True):
        ...
        if silent:
            ...
            handle = NoteHandle(PlaybackImplementer._do_start_note(
                self, start_pitch, start_volume, properties, other_param_start_values), self)
            ...
            handle = NoteHandle(self._do_start_note(
                start_pitch, start_volume, properties, other_param_start_values), self)
...
class MidiPlaybackImplementer(PlaybackImplementer):
    ...
    def _do_start_note(self, pitch, volume, properties, other_parameter_start_values: dict = None):
        note_id = super()._do_start_note(pitch, volume, properties, other_parameter_start_values)
