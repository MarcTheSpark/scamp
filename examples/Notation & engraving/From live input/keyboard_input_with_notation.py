"""
SCAMP EXAMPLE: Notating Computer Keyboard Input
...
Same as Computer Keyboard Input, except that a metronome is playing back while the user plays notes with the
keyboard, and the result is rendered as music notation.
"""
